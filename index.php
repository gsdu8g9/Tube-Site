...
<gcse:search></gcse:search>
							...
							<div id="c_catogory_padding2"><!--recently added-->
								<div id="c_catogory2">
									...
									<div id="cat_cliparea">
										...
										$videos = new Videos();
										$recent_videos = $videos -> get_recent_videos(0, 16);
										...
										while ($i < $num_rows) {
											...
											$descripton = mysql_result($recent_videos, $i, "description");
							...
							$res = mysql_query($cat_query) or die(mysql_error());
							$num = mysql_num_rows($res);
							$i = 0;

							while ($i < $num) {
								$cat_item = mysql_result($res, $i, "name");
								echo "<div id='c_catogory_padding'>";
								echo "<div id='c_catogory'>";
								echo "<div id='cat_title'>";
								echo "<div id='t1'>$cat_item</div>";
								echo "</div>";
								echo "<div id='cat_title2'>";
								echo "<div id='t2'>";
								echo "<div id='t2_text'></div>";
								echo "<div id='t2_more'><a href='category.php?cat=$cat_item'>  View all items >>> </a></div>";
								echo "<div id='t2_image'></div>";
								echo "</div>";
								echo "</div>";
								...
								if ($num_rows > 0) {
									...
									if ($num_rows > 0) {
										...
										while ($count < 4) {
											$id = mysql_result($related_videos, $count, "id");
											$thumbnail = mysql_result($related_videos, $count, "thumbnail");
											$title = mysql_result($related_videos, $count, "title");
											$descripton = mysql_result($related_videos, $count, "description");
											$views = mysql_result($related_videos, $count, "views");
											...
											echo "<div id='uuu'>";
											echo "<div id='clip_image'><a href='view.php?id=$id'>";
											echo "<img src='$thumbnail' class='clipimage'/>";
											echo "</a>";
											echo "</div>";
											echo "<div id='clip_name'>$title</div>";
											echo "<div id='clip_date'>$short<br /><font color='#FF3300'>Viewed $views times</font>";
											echo "</div>";
											echo "</div>";
											echo "</div> ";
